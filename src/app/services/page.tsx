...
export default function Services() {
  ...
  const serviceItems = [
    { 
      id: "01", 
      title: t('services_ecosystem'), 
      detail: t('services_ecosystem_detail'),
      icon: <Scan className="text-emerald" />,
      colSpan: "lg:col-span-2"
    },
    { 
      id: "02", 
      title: t('services_invisalign'), 
      detail: t('services_invisalign_detail'),
      icon: <Zap className="text-gold" />,
      colSpan: "lg:col-span-1"
    },
    { 
      id: "03", 
      title: t('services_robotic'), 
      detail: t('services_robotic_detail'),
      icon: <Microscope className="text-emerald" />,
      colSpan: "lg:col-span-1"
    },
    { 
      id: "04", 
      title: t('services_sculpting'), 
      detail: t('services_sculpting_detail'),
      icon: <Sparkles className="text-gold" />,
      colSpan: "lg:col-span-1"
    },
    { 
      id: "05", 
      title: t('services_regenerative'), 
      detail: t('services_regenerative_detail'),
  ...
  const pricingItems = [
    { name: t('pricing_assessment'), usd: "$250", dop: "RD$ 15,000" },
    { name: t('pricing_ceramic'), usd: "$800", dop: "RD$ 48,000" },
    { name: t('pricing_invisalign'), usd: `${t('pricing_from')} $3,500`, dop: `RD$ 210,000` },
    { name: t('pricing_robotic'), usd: `${t('pricing_from')} $1,200`, dop: `RD$ 72,000` }
  ];
  ...
  return (
    <div className="min-h-screen bg-obsidian text-cloud relative overflow-hidden">
      ...
      <div className="container-premium z-10 relative">
        ...
        >
        <span className="text-gold font-bold tracking-[0.2em] md:tracking-[0.5em] uppercase text-[10px] lg:text-xs text-center lg:text-left block mb-8">{t('services_eyebrow')}</span>
        <h1 className="font-syne text-5xl md:text-7xl lg:text-hero font-bold mt-6 text-center lg:text-left">
          {t('services_title')} <br/><span className="text-luxury text-emerald lowercase">{t('services_title_span')}</span>
        </h1>
        ...
        <section className="mt-32 md:mt-48 lg:mt-[20rem]">
           <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end mb-16 md:mb-24 space-y-8 lg:space-y-0 text-center lg:text-left">
              <div className="text-center lg:text-left">
                 <span className="text-emerald font-bold tracking-[0.4em] uppercase text-xs">{t('services_transparency')}</span>
                 <h2 className="font-syne text-5xl md:text-7xl lg:text-8xl font-bold mt-4 tracking-tighter italic text-gold leading-none">{t('services_investment')} <br/><span className="text-white not-italic lowercase text-luxury">{t('services_investment_span')}</span></h2>
              </div>
              <div className="glass-obsidian px-8 py-4 lg:px-10 lg:py-5 rounded-full border border-gold/20 backdrop-blur-xl group hover:border-gold transition-colors text-center lg:text-left">
                 <p className="text-[10px] font-bold tracking-[0.3em] text-gray-500 group-hover:text-gold transition-colors italic uppercase">{t('services_dynamic')}</p>
              </div>
           </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left relative z-10 border-collapse min-w-[600px] lg:min-w-[800px]">
                  <thead className="border-b border-white/5">
                      <tr className="text-gray-500 text-[8px] lg:text-xs uppercase tracking-[0.3em] lg:tracking-[0.5em] font-black">
                        <th className="px-6 md:px-12 lg:px-20 py-8 md:py-12 lg:py-16">{t('services_protocol')}</th>
                        <th className="px-6 md:px-12 lg:px-20 py-8 md:py-12 lg:py-16">{t('services_inv_usd')}</th>
                        <th className="px-6 md:px-12 lg:px-20 py-8 md:py-12 lg:py-16">{t('services_inv_dop')}</th>
                      </tr>
                  </thead>
              ...
              >
               <CircleDollarSign className="w-16 h-16 md:w-24 md:h-24 lg:w-32 lg:h-32 text-gold mx-auto animate-float drop-shadow-[0_20px_40px_rgba(212,175,55,0.4)]" />
                <h2 className="font-syne text-4xl md:text-6xl lg:text-[7rem] font-bold tracking-tighter leading-[0.85]">
                   {t('services_cta_title')} <br/><span className="text-luxury text-emerald lowercase">{t('services_cta_title_span')}</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-6 md:gap-10 pt-8 md:pt-12">
                   ...
                   <Link href="/contact" className="group/concierge flex items-center space-x-6 font-bold tracking-widest text-sm md:text-base uppercase text-gold hover:text-white transition-all">
                      <span className="italic font-cormorant text-xl md:text-2xl normal-case">{t('services_concierge')}</span>

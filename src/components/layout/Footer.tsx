  ...
  return (
    <footer className="section-padding bg-black text-center relative overflow-hidden">
      ...
      <div className="container-premium relative z-10 space-y-8 lg:space-y-12">
        <p className="text-[10px] text-emerald font-bold uppercase tracking-[1em] lg:tracking-[1.5em] opacity-60">{t('footer_spec')}</p>
        ...
        <p className="text-[10px] text-gray-700 font-bold uppercase tracking-[0.5em] lg:tracking-[1em] italic">{t('footer_copy')}</p>
      </div>
    </footer>
  );
}
